...
export const adminComponentSchemas = {
  ...
  CommsDeliveriesAdmin: {
    props: z.object({
      ...
      retryLabel: z.string(),
      retryingLabel: z.string(),
      statusFilterLabel: z.string(),
      allStatusesLabel: z.string(),
      columns: z.object({
        when: z.string(),
        status: z.string(),
        to: z.string(),
  ...
  WebhookSubscriptionsAdmin: {
    props: z.object({
      ...
      refreshLabel: z.string(),
      urlLabel: z.string(),
      eventTypesLabel: z.string(),
      eventTypesHelper: z.string(),
      ...
      disabledLabel: z.string(),
      signingSecretLabel: z.string(),
      deliveriesTitle: z.string(),
      deliveriesEmptyLabel: z.string(),
      retryLabel: z.string(),
      retryingLabel: z.string(),
      columns: z.object({
        url: z.string(),
    ...
    description: "Outbound webhook subscriptions and delivery log",
  },
  IntegrationsLlmForm: {
    props: z.object({
      ...panelLabels,
  ...
  AgentsAdminForm: {
    props: z.object({
      ...
      createTaskSectionTitle: z.string(),
      createTaskSectionDescription: z.string(),
      taskPromptLabel: z.string(),
      taskAgentLabel: z.string(),
      createTaskLabel: z.string(),
      creatingTaskLabel: z.string(),
      createTaskSuccessMessage: z.string(),
      viewTaskLabel: z.string(),
      stepsSectionTitle: z.string(),
      artifactsSectionTitle: z.string(),
      runSummaryLabel: z.string(),
      noArtifactsMessage: z.string(),
      stepStatusOkLabel: z.string(),
      stepStatusDeniedLabel: z.string(),
      stepStatusErrorLabel: z.string(),
      runningTaskLabel: z.string(),
    }),
  ...
  SessionReplayAdmin: {
    props: z.object({
      ...
      empty: z.string(),
      sessionColumnHeader: z.string(),
      userColumnHeader: z.string(),
      chunksColumnHeader: z.string(),
      lastSeenColumnHeader: z.string(),
      searchPlaceholder: z.string(),
      searchLabel: z.string(),
      clearSearchLabel: z.string(),
      identifiedMidSessionLabel: z.string(),
