...
export const ROUTE_TABLE: readonly PlatformRouteEntry[] = [
  ...
  },
  {
    ...
    template: "admin_scope",
    requiresAuth: true,
    adminRouteId: "scope",
  },
  {
    path: "/admin/settings/analytics",
    template: "admin_analytics",
    requiresAuth: true,
    adminRouteId: "analytics",
  },
  {
    path: "/admin/settings/flags",
    template: "admin_flags",
    requiresAuth: true,
    adminRouteId: "flags",
  },
  {
  ...
  {
    path: "/admin/settings/traces",
    template: "admin_traces",
    requiresAuth: true,
    adminRouteId: "traces",
  },
  {
    path: "/admin/settings/agents",
    template: "admin_agents",
    requiresAuth: true,
    adminRouteId: "agents",
  },
