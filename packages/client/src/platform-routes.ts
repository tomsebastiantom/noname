...
export function platformTemplateFromPath(pathname: string): string {
  ...
  if (pathname.startsWith("/admin/pages/tree")) return "admin_pages_tree";
  ...
  if (pathname === "/admin/settings/traces") return "admin_traces";
  if (pathname === "/admin/settings/agents") return "admin_agents";
...
export function adminActiveNavFromPath(pathname: string): string {
  ...
  if (pathname === "/admin/settings/traces") return "traces";
