...
function marksFromTipTap(marks: JSONContent["marks"]): RichTextMark[] {
...
function richTextInlineToTipTap(nodes: RichTextNode[] | undefined): JSONContent[] {
...
function tipTapInlineToRichText(inline: JSONContent[] | undefined): RichTextNode[] {
...
function tableCellInline(cell: JSONContent): JSONContent[] | undefined {
  const paragraph = cell.content?.find((child) => child.type === "paragraph");
  return paragraph?.content;
}

function richTextTableCellToTipTap(cell: RichTextNode): JSONContent {
...
function tipTapTableCellToRichText(cell: JSONContent): RichTextNode {
  return {
    nodeType: "table-cell",
...
function listItemsFromTipTap(items: JSONContent[] | undefined): RichTextNode[] {
  return (items ?? [])
...
export function richTextToTipTapJson(doc: RichTextDocument): JSONContent {
...
export function tipTapJsonToRichText(json: JSONContent): RichTextDocument {
